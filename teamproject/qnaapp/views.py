...
def question_modify(request, question_id):
    ...
    if request. user != question.author:
        ...
        return redirect('qua:detail', question_id=question.id)
...
def answer_modify(request, answer_id):
    ...
    if request.user != answer.author:
        messages.error(request, '수정 권한이 없으시개!')
        return redirect('qua:detail', question_id=answer.question.id)
...
def answer_delete(request, answer_id):
    ...
    if request.user != answer.author:
        messages.error(request, '삭제할 권한이 없개!')
        return redirect('qna:detail', answer_id=answer.id)
    answer.delete()
    return redirect('qna:index')
